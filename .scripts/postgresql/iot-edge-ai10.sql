...
DROP DATABASE IF EXISTS "iot-edge-ai20";
--
-- Name: iot-edge-ai20; Type: DATABASE; Schema: -; Owner: -
--

CREATE DATABASE "iot-edge-ai20" WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


\unrestrict mxtmdLkbhrjgyaTtpEH6lt2YtwvBCQuZm7tbmtH99rJSDMhUQwZ0Ba1AQPtTBUP
\encoding SQL_ASCII
\connect -reuse-previous=on "dbname='iot-edge-ai20'"
\restrict mxtmdLkbhrjgyaTtpEH6lt2YtwvBCQuZm7tbmtH99rJSDMhUQwZ0Ba1AQPtTBUP
