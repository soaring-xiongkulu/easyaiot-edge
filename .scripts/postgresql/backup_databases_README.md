...
- ✅ 按时间戳创建备份目录
- ✅ 备份多个数据库（iot-edge-ai20、iot-edge-video20、iot-edge-device20）
- ✅ 彩色日志输出，清晰显示备份状态
- ✅ 备份统计信息
...
│   ├── iot-edge-ai20.sql
│   ├── iot-edge-video20.sql
│   └── iot-edge-device20.sql
...
[INFO] 开始备份数据库: iot-edge-ai20
[INFO] ✓ 数据库 iot-edge-ai20 备份成功: .../iot-edge-ai20.sql (大小: 2.5M)
[INFO] 开始备份数据库: iot-edge-video20
[INFO] ✓ 数据库 iot-edge-video20 备份成功: ...
[INFO] 开始备份数据库: iot-edge-device20
[INFO] ✓ 数据库 iot-edge-device20 备份成功: ...
...
PGPASSWORD=iot45722414822 psql -h localhost -U postgres -d iot-edge-ai20 < backup_dir/iot-edge-ai20.sql

# 方法2：使用 Docker 容器内的 psql（推荐，版本匹配）
docker exec -i -e PGPASSWORD=iot45722414822 postgres-server \
    psql -U postgres -h localhost -p 5432 -d iot-edge-ai20 < backup_dir/iot-edge-ai20.sql

# 恢复 device 数据库示例
docker exec -i -e PGPASSWORD=iot45722414822 postgres-server \
    psql -U postgres -h localhost -p 5432 -d iot-edge-device20 < backup_dir/iot-edge-device20.sql
```
