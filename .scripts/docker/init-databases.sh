...
get_sql_file() {
    case "$1" in
        "iot-edge-ai20") echo "iot-edge-ai10.sql" ;;
        "iot-edge-video20") echo "iot-edge-video10.sql" ;;
        "ruoyi-vue-pro20") echo "ruoyi-vue-pro10.sql" ;;
        *) echo "" ;;
    esac
}

# 数据库列表（仅 AI / VIDEO / 若依 三套库）
DATABASES=("iot-edge-ai20" "iot-edge-video20" "ruoyi-vue-pro20")
