...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    public String updateUserAvatar(Long id, InputStream avatarFile) {
        ...
        String filename = FileUtils.generatePath(content, "avatar.png");
        Path dest = Paths.get(avatarDir, filename).toAbsolutePath().normalize();
        FileUtil.mkdir(dest.getParent().toString());
        FileUtil.writeBytes(content, dest.toFile());
        String prefix = avatarUrlPrefix.startsWith("/") ? avatarUrlPrefix : "/" + avatarUrlPrefix;
        if (!prefix.endsWith("/")) {
            prefix = prefix + "/";
        }
        String avatar = prefix + filename;
        // 更新路径
